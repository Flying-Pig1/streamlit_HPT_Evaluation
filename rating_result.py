...
def process_csv(file_path, output_file_path):
    ...
    df_extracted = df[["image_name", "question", "difficulty", "hpto1.1_rating", "hpto1.2_rating", "cogvlm2_rating",]].copy()
    ...
    # 重新排列列顺序
    columns_order = ["id", "image_name", "question", "task", "difficulty", "hpto1.1_rating", "hpto1.2_rating", "cogvlm2_rating"]
...
def plot_task(df):
    ...
    models = ['hpto1.1_rating', 'hpto1.2_rating', 'cogvlm2_rating']
    ...
    for task in tasks:
        ...
        avg_scores.append({
            'task': task,
            'hpto1.1': task_df['hpto1.1_rating'].mean(),
            'hpto1.2': task_df['hpto1.2_rating'].mean(),
...
def plot_difficulty(df):
    ...
    for difficulty in difficulties:
        ...
        avg_scores.append({
            ...
            'hpto1.1': difficulty_df['hpto1.1_rating'].mean(),
            'hpto1.2': difficulty_df['hpto1.2_rating'].mean(),
...
file_path = 'result_hpto1.1_hpto1.2_cogvlm2.csv'  # 替换为你的输入文件路径
output_file_path = 'rating_result_hpto1.1_hpto1.2_cogvlm2.csv'  # 替换为你想要保存的文件路径
